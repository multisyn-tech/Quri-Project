...
import CardPayment from '../CardPay/CardPayment.jsx';
    ...
    return (
        ...
        <div className="fixed inset-x-0 bottom-0 rounded-lg bg-white p-4 shadow-lg z-50">
            <div className='w-full'>
                ...
                <div>
                    <p className='text-sm'>Enter the 6 digit code that is sent to your number</p>
                </div>
                ...
                <div className="fixed inset-0 flex items-center justify-center">
                    <CardPayment onClose={closeSignUp} />
                </div>
            )}
