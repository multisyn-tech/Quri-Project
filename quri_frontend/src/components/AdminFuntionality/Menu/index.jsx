                ...
                <Accordion>
                  ...
                  <AccordionDetails>
                    <Grid container spacing={2}>
                      ...
                      {currentPosts.filter((menu) => menu.CategoryName === category).map((menu) => (
                  ...
                  <Grid item xs={12} key={category}>
                    <Accordion>
                      ...
                      <AccordionDetails>
                        <Grid container spacing={2}>
                          {currentPosts
                            .filter((menu) => menu.CategoryName === category)
                            .map((menu) => {
                              return (
                                <Grid item xs={12} sm={6} md={4} lg={3} key={menu.MenuID}>
                                  <Paper
                                  ...
                                  >
                                    ...
                                    <Typography
                                      variant="body1"
                                      className={getStatusColor(menu.MenuStatus)}
                                    >
                                      Menu Status: {menu.MenuStatus}
                                    </Typography>
                                    <div className="flex justify-between mt-4">
